...
## 2.6.1 convert weekly shortage of stuff to monthly
...
nystate_df %>% 
  filter(submitted_data == "Y") %>% 
   select(month, day, county, one_week_supply_of_ventilator_supplies) %>% 
  mutate(
    one_week_supply_of_ventilator_supplies = str_replace(one_week_supply_of_ventilator_supplies, "N", 0)
  )
