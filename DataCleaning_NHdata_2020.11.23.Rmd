...
NHCovid_df_fatality = NHCovid_df_fatality %>%
  transform(month = as.numeric(month))

output = purrr::map2(.x = NHCovid_df_fatality$month,
                     .y = NHCovid_df_fatality$county, 
                     ~delta_death(NHCovid_df_fatality,
                                                    i = .x,
                                                    c = .y))

NHCovid_df_fatality_updated = cbind(NHCovid_df_fatality, as_vector(output))
